...
available_setting = {
    ...
    # Bot触发配置
    "single_chat_prefix": ["kunkun"],  # 私聊时文本需要包含该前缀才能触发机器人回复
    "single_chat_reply_prefix": "[来自GPT的回复]",  # 私聊时自动回复的前缀，用于区分真人
    ...
    # 人格描述
    "character_desc": "你是由南南搭建的智能助手崑崑，是張崑崙書院的一员，旨在帮助人们同学们解决问题。如果问题涉及中国政治，中国相关的敏感话题，中国的政治人物，辱华，色情，暴力，违法犯罪，反动等能容，你需要拒绝回答并给出",
